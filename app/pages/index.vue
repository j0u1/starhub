...
<template>
  <section class="min-h-dvh flex flex-col items-center justify-center gap-8">
    ...
    <div class="relative group">
      ...
      >
      <div
        class="absolute cursor-pointer right-2.5 top-1/2 -translate-y-1/2  rounded-xl p-1.5 bg-secondary origin-right duration-150 transition-all"
        :class="`${!userRef ? 'pointer-events-none translate-x-2' : 'pointer-events-auto translate-x-0'}`"
        :style="{scale: !userRef ? 0 : 1}"
      >
